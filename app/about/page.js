...
export const metadata = {
    title: 'About Aroven Tech | Best Software Company in Lucknow | Our Team & Leadership',
    description: 'Meet the team behind Lucknow fastest growing IT company. CEO Mr. Shyam Chaturvedi and Director Mr. Gaurav Yadav leading Aroven Tech in Gomti Nagar. Serving 100+ clients across India with best website and software solutions.',
    keywords: 'about Aroven Tech, shyam chaturvedi ceo, gaurav yadav director, best it team in lucknow, gomti nagar it office, software company profile lucknow, lucknow it company',
    robots: 'index, follow',
    openGraph: {
        title: 'About Aroven Tech Lucknow - Best IT Company Team',
    ...
    return (
        <main className="section-padding container">
            <h1 className="text-center" style={{ marginTop: '80px' }}>
                About <span className="gradient-text">Aroven Tech Lucknow</span>
            </h1>
            ...
            <div style={{ margin: '2rem auto', maxWidth: '600px', borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--glass-border)' }}>
                <Image
                    ...
                    alt="Technical Team of Best Software Company in Lucknow - Aroven Tech Gomti Nagar Office"
                    width={1200}
                    height={600}
            ...
            <div className="text-center" style={{ marginTop: '3rem', fontSize: '1.2rem', color: 'var(--text-dim)' }}>
                ...
                <p style={{ maxWidth: '800px', margin: '0 auto' }}>
                    Aroven Tech is Lucknow premier software and website development company, headquartered in Gomti Nagar.
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', maxWidth: '900px', margin: '0 auto' }}>
                    ...
                    <div className="glass" style={{ padding: '2rem', borderRadius: '16px', textAlign: 'center' }}>
                        ...
                        <p style={{ marginTop: '1rem', fontSize: '0.9rem', color: 'var(--text-dim)' }}>
                            Visionary leader focused on innovation and excellence in IT sector. Leading Aroven Tech to become the best software company in Lucknow.
                        </p>
                    </div>
                    ...
                    <div className="glass" style={{ padding: '2rem', borderRadius: '16px', textAlign: 'center' }}>
                        ...
                        <p style={{ marginTop: '1rem', fontSize: '0.9rem', color: 'var(--text-dim)' }}>
                            Driving operational efficiency and strategic growth for Aroven Tech. Expert in software development and digital transformation.
                        </p>
                    </div>
